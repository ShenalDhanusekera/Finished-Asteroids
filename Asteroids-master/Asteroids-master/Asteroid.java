...
public class Asteroid extends SmoothMover
{
    ...
    /**
     * setSize method sets the size of the asteroid
     * 
     * @param integer that represent the size of the asteroid
    ...
    /**
     * hit method is the method that counts the scores break up the Asteroid into three pieces. 
     * 
     * @param integer that represent the amount of damage it does to an object
     * @return Does not return anything
     */
    ...
    /**
     * breakUp method breaks up the Asteroids into debris(little peaces), then
     * remove the object and makes a explosion sound
     * 
     * @param integer that represent the number of peaces that the Asteroids will break up into
     * @return Does not return anything
     */
