...
public class Space extends World
{
    ...
    /**
     * paintStars method paint stars in the background
     * 
     * @param integer that represent the number of Stars in the background
    ...
    /**
     * addAsteroids method adds the Asteroids to the world
     * 
     * @param integer that represent the number of Asteroids
     * @return Does not return anything
     */
